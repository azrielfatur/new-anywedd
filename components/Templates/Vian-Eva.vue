<template>
    <div>
        ...
        <div class="relative">
            <img src="img/16436960169351.webp" class="w-full hidden md:block h-screen object-cover" alt="Vian & Eva">
            <img src="img/cover-mobile.webp" class="w-full block md:hidden h-screen object-cover" alt="Vian & Eva">
  ...
  components: { GuestModal },
    ...
    data() {
        return {
            GuestInvited: '',
            PlayingAudio: false,
            FileAudio: new Audio('music/Paul Anka  Put Your Head on My Shoulder Cover by The Macarons Project.mp3'),
